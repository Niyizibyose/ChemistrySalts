...
public class ActionManagerFetch : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var content0 = new GUIContent(@" Fill all beakers with water", BoxTexture,
            "Remove a loopful of bacteria from tube");
        contents[0] = content0;

        var content1 = new GUIContent(@"Label them A, B , C", BoxTexture,
            "Place the loopful of bacteria in the center of the target circle on the slide");
        contents[1] = content1;

        var content2 = new GUIContent(@"Add one teaspoon sugar in beaker A, two teaspoons sugar n\ in beaker B, and three
teaspoons in beaker C.", BoxTexture,
        ...
        var content3 = new GUIContent(@"Stir with spoon", BoxTexture,
